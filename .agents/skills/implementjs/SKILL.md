...
- [Lifecycle](./LIFECYCLE.md) - How to know when a component is mounted and unmounted and how to listen to events from the document or window without needing to manually unsubscribe
