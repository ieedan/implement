...
Because the files are generated by the dev server and build, a fresh clone won't have them yet. For `tsc --noEmit` scripts and CI, call `sync` first to write them without running Vite:
