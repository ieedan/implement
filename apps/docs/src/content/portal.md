...
That's composition covered. The next part steps outside your component tree entirely and works with the document itself, starting with [raw HTML](/docs/html).
