...
export default function AvatarDemo() {
	return Div(
		...
		Avatar(AvatarImage({ src: "https://github.com/ieedan.png", alt: "@ieedan" }),
			AvatarFallback("AB"),
		),
		Avatar(AvatarImage({ src: "https://github.com/broken-link-404.png/nope", alt: "broken" }),
			AvatarFallback("ER"),
		),
		Div(
			{
			...
			Avatar(AvatarImage({ src: "https://github.com/github.png", alt: "@github" }),
				AvatarFallback("GH"),
			),
