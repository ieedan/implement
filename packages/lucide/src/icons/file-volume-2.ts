...
/**
 * Lucide `file-volume-2` icon.
 * @see https://lucide.dev/icons/file-volume-2
 */
export const FileVolume2 = /* @__PURE__ */ createLucideIcon(
	"file-volume-2",
...
export { FileVolume2 as FileVolume2Icon };
