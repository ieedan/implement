...
class AccordionState {
    ...
    constructor(readonly opts: Pick<AccordionRootProps, "type" | "loop">, readonly ref: Ref<HTMLDivElement>) { }
...
export function Accordion(
    ...
    return AccordionCtx.Provide(state).To(
        Div({ this: root, "data-accordion-root": "", onKeydown: (e) => state.onKeyDown(e), ...restProps }, ...children),
    );
}
